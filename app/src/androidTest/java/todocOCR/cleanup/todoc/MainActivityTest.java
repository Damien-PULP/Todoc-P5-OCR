package todocOCR.cleanup.todoc;
...
import todocOCR.cleanup.todoc.ui.MainActivity;
import todocOCR.cleanup.todoc.ui.TasksAdapter;
import todocOCR.cleanup.todoc.utils.DeleteViewAction;
...
import static todocOCR.cleanup.todoc.TestUtils.withRecyclerView;
...
public class MainActivityTest {
    ...
    public void initDb() {
        ...
        TasksAdapter adapter = (TasksAdapter) listTasks.getAdapter();

        final int size = adapter.getItemCount();
        for (int i = 0; i < size; i++) {
            onView(ViewMatchers.withId(R.id.list_tasks)).perform(RecyclerViewActions.actionOnItemAtPosition(0, new DeleteViewAction()));
        }
    }
